    ...
    @section('content')
        <div class="container mx-auto p-4">
            <h1 class="text-2xl font-bold mb-4">Chi tiết Danh mục: {{ $category->Name }}</h1>

            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="mb-4">
                    <p class="text-gray-700 font-bold">ID:</p>
                    <p class="text-gray-900">{{ $category->CategoryID }}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-700 font-bold">Tên Danh mục:</p>
                ...
                <div class="mb-4">
                    ...
                    <p class="text-gray-900">
                        <span class="px-2 py-1 font-semibold leading-tight rounded-full {{ $category->Status ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-gray-900">{{ $category->Create_at }}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-700 font-bold">Ngày cập nhật:</p>
                    <p class="text-gray-900">{{ $category->Update_at }}</p>
                </div>

                <div class="flex items-center justify-between mt-6">
                    <a href="{{ route('admin.categories.edit', $category->CategoryID) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                        Chỉnh sửa
                    </a>
